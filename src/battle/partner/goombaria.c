...
#define NAMESPACE battle_partner_goombaria
...
s32 N(DefaultAnims)[] = {
    STATUS_KEY_NORMAL,    ANIM_Goombaria_Walk,
    STATUS_KEY_STONE,     ANIM_Goombaria_Still,
    STATUS_KEY_SLEEP,     ANIM_Goombaria_Still,
    STATUS_KEY_POISON,    ANIM_Goombaria_Still,
    STATUS_KEY_STOP,      ANIM_Goombaria_Still,
    STATUS_KEY_KO,        ANIM_Goombaria_Hurt,
    STATUS_KEY_INACTIVE,  ANIM_Goombaria_Still,
    STATUS_END,
};
...
ActorBlueprint NAMESPACE = {
    .flags = 0,
    .type = ACTOR_TYPE_GOOMBARIA,
    .level = ACTOR_LEVEL_GOOMBARIA,
    .maxHP = 99,
...
EvtScript N(EVS_HandleEvent) = {
    ...
    Switch(LVar0)
        ...
        CaseOrEq(EVENT_HIT)
            SetConst(LVar1, ANIM_Goombaria_Hurt) // HurtStill
            SetConst(LVar2, ANIM_Goombaria_Still) // HurtStill
            ExecWait(EVS_Partner_Hit)
            SetConst(LVar1, ANIM_Goombaria_Still) // HurtStill
        ...
        CaseEq(EVENT_BURN_CONTACT)
            SetConst(LVar1, ANIM_Goombaria_Hurt) // BurnHurt1
            Set(LVar2, 12)
            SetConst(LVar3, ANIM_Goombaria_Hurt) // BurnHurt2
            ExecWait(EVS_Partner_BurnContact)
            SetConst(LVar1, ANIM_Goombaria_Hurt) // HurtStill
            ExecWait(EVS_Partner_Drop)
        CaseEq(EVENT_BURN_HIT)
            SetConst(LVar1, ANIM_Goombaria_Hurt) // BurnHurt1
            SetConst(LVar2, ANIM_Goombaria_Hurt) // BurnHurt2
        ...
        CaseEq(EVENT_RECOVER_FROM_KO)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Goombaria_Idle)
            SetConst(LVar2, ANIM_Goombaria_Run)
            Set(LVar3, 0)
        ...
        CaseOrEq(EVENT_BLOCK)
            Call(PlaySoundAtActor, ACTOR_PARTNER, SOUND_NO_DAMGE)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Goombaria_Still) // Block
            ExecWait(EVS_Partner_NoDamageHit)
            Wait(10)
        EndCaseGroup
        CaseDefault
...
EvtScript N(EVS_Celebrate) = {
    SetConst(LVar0, PRT_MAIN)
    SetConst(LVar1, ANIM_Goombaria_Celebrate) // CelebrateLoop
    SetConst(LVar2, ANIM_Goombaria_Celebrate)
    SetConst(LVar3, ANIM_Goombaria_Idle)
...
EvtScript N(EVS_RunAway) = {
    SetConst(LVar0, PRT_MAIN)
    SetConst(LVar1, ANIM_Goombaria_Run)
...
EvtScript N(EVS_RunAwayFail) = {
    ...
    Call(SetAnimation, ACTOR_PARTNER, -1, ANIM_Goombaria_Run)
    Call(SetActorYaw, ACTOR_PARTNER, 0)
    Call(RunToGoal, ACTOR_PARTNER, 0)
    Call(SetAnimation, ACTOR_PARTNER, -1, ANIM_Goombaria_Idle)
    Call(UseIdleAnimation, ACTOR_PARTNER, true)
    Return
    End
};
    ...
    Switch(LVar0)
        CaseEq(PHASE_PLAYER_BEGIN)
            IfFalse(GF_Tutorial_SwapTurnOrder)
                ...
                Wait(5)
                Call(ActorSpeak, MSG_CH0_00BA, ACTOR_PARTNER, 0, ANIM_Goombaria_Talk, ANIM_Goombaria_Idle)
                Call(SetActorYaw, ACTOR_PLAYER, 150)
                Wait(1)
                Call(SetActorYaw, ACTOR_PLAYER, 120)
                Wait(1)
...
EvtScript N(EVS_ReturnHome_Miss) = {
    ...
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Goombaria_Jump) // PreHeadbonk
    ...
    Call(SetActorDispOffset, ACTOR_PARTNER, 0, 19, 0)
    Wait(1)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Goombaria_Idle)
    Call(SetActorDispOffset, ACTOR_SELF, 0, 0, 0)
    Wait(2)
    Call(SetGoalToHome, ACTOR_PARTNER)
...
EvtScript N(EVS_Attack_Headbonk1) = {
    ...
    Call(UseBattleCamPreset, BTL_CAM_PARTNER_MIDAIR)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Goombaria_Jump) // Headbonk
    Call(SetActorDispOffset, ACTOR_PARTNER, 0, 9, 0)
    Call(SetGoalToTarget, ACTOR_PARTNER)
    Call(SetJumpAnimations, ACTOR_PARTNER, 0, ANIM_Goombaria_Jump, ANIM_Goombaria_Jump, ANIM_Goombaria_Jump) // Headbonk
...
EvtScript N(EVS_Move_Tattle) = {
    ...
    Call(ActorSpeak, LVar0, ACTOR_SELF, PRT_MAIN, ANIM_Goombaria_Talk, ANIM_Goombaria_Idle)
...
EvtScript N(EVS_Move_Charge) = {
    ...
    Wait(10)
    Call(SetAnimation, ACTOR_PARTNER, -1, ANIM_Goombaria_Jump) // PreHeadbonk
    Call(SetActorDispOffset, ACTOR_PARTNER, 0, 19, 0)
    Call(GetActorPos, ACTOR_PARTNER, LVar0, LVar1, LVar2)
    Add(LVar1, 15)
    ...
    IfEq(LVar0, 0)
        ...
        Call(SetActorJumpGravity, ACTOR_PARTNER, Float(1.4))
        Call(GetActorPos, ACTOR_PARTNER, LVar0, LVar1, LVar2)
        Call(SetJumpAnimations, ACTOR_PARTNER, ANIM_Goombaria_Jump, 0x00000001, ANIM_Goombaria_Jump, ANIM_Goombaria_Jump)
        Call(SetGoalPos, ACTOR_PARTNER, LVar0, LVar1, LVar2)
